...
Now we will generate a simple application using the `Streamlit` library. In the `src` directory, we create a new file named `app.py` that we will modify with the following code:
