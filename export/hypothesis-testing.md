...
df = pd.read_csv('https://raw.githubusercontent.com/4geeksacademy/machine-learning-content/blob/master/assets/toy_dataset.csv')
...
df = pd.read_csv('https://raw.githubusercontent.com/4geeksacademy/machine-learning-content/blob/master/assets/blood_pressure.csv')
...
```python
df_anova = pd.read_csv('https://raw.githubusercontent.com/4geeksacademy/machine-learning-content/blob/master/assets/PlantGrowth.csv')
...
```python
df_chi = pd.read_csv('https://raw.githubusercontent.com/4geeksacademy/machine-learning-content/blob/master/assets/chi-test.csv')
